...
- **500,000+ UART Entries** - Massive 5.6MB capacity for extended monitoring
...
Max Capacity       | ~5K      | 500K+ entries (5.6MB)
...
```cpp
#define MAX_UART_ENTRIES 500000   // Maximum Flash entries
...
|| **Flash Usage** | ~1.04MB (79.4% of 1.3MB app partition) |
...
- 📊 **Massive Storage System** - Up to 500,000+ UART entries with 5.6MB LittleFS partition
